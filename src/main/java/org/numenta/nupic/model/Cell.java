...
public class Cell implements Comparable<Cell>, Serializable {
    ...
    public Cell(Column column, int colSeq) {
        this.column = column;//单元所在的列
        this.index = column.getIndex() * column.getNumCellsPerColumn() + colSeq;//单元的索引等于列的索引*列中单元的数量+列中第几个单元的编号，这样所有列中的所有单元都能按顺序编号
        this.boxedIndex = new Integer(index);//单元的打包索引
