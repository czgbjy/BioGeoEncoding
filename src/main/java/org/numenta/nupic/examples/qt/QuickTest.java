...
public class QuickTest {
    ...
    public static void main(String[] args) {
        ...
        CLAClassifier classifier = new CLAClassifier(new TIntArrayList(new int[] { 1 }), 0.1, 0.3, 0);///分类器
    ...
    public static Parameters getParameters() {
        ...
        parameters.set(KEY.CONNECTED_PERMANENCE, 0.8);//如果突触的持久度值大于此值，则称为连接
        parameters.set(KEY.MIN_THRESHOLD, 5);         //如果在一个片段上激活的突触的数量至少是这个阈值，它被选为激活列中最佳匹配的单元。
