...
public abstract class AbstractFlatMatrix<T> implements FlatMatrix<T>, Serializable {
     ...
     * a flat index.
     *  返回坐标的数组，坐标由一个一维的索引计算
     * @param   index   specified flat index 指定的一维的索引
     * @return  a coordinate array 坐标数组
     */
    @Override
     ...
     * index computation.初始化用于多维索引计算的内部助手数组
     * @param dimensions matrix dimensions 矩阵维度
